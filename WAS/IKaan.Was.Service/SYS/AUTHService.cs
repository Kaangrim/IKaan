	...
	public static class AUTHService
	{
		...
		public static WasRequest CheckLoginUser(WasRequest request)
		{
			try
			{
				...
				var data = DaoFactory.Instance.QueryForObject<UMLoginUser>("GetLoginUser", parameter);
				...
				try
				{
					DaoFactory.Instance.Insert("InsertLoginLog", parameter);
				}
				catch (Exception ex)
				{
				...
				//공통코드 받아오기
				var codes = DaoFactory.Instance.QueryForList<UMCodeLookup>("SelectCodeLookup", parameter);
				data.Codes = codes;
				request.Data = data;
		...
		public static WasRequest GetMainMenu(WasRequest request)
		{
			try
			{
				...
				if (request.Parameter != null)
					parameter = request.Parameter.JsonToAnyType<DataMap>();
				var result = DaoFactory.Instance.QueryForList<UMMainMenu>("GetMainMenu", parameter);
				request.Data = result;
		...
		public static WasRequest GetMenuView(WasRequest request)
		{
			try
			{
				...
				var menuView = DaoFactory.Instance.QueryForObject<UMMenuView>("GetMenuView", parameter);
				var menuViewButton = DaoFactory.Instance.QueryForList<UMMenuViewButton>("GetMenuViewButton", parameter);
		...
		public static WasRequest SaveBookmark(WasRequest request)
		{
			try
			{
				...
				var data = DaoFactory.Instance.QueryForObject<AABookmark>("SelectBookmark", parameter);
		...
		public static WasRequest GetDictionary(WasRequest request)
		{
			try
			{
				...
				var list = DaoFactory.Instance.QueryForList<UMCodeValue>("GetDictionary", parameter);
				request.Data = list;
		...
		public static WasRequest GetMessage(WasRequest request)
		{
			try
			{
				...
				var list = DaoFactory.Instance.QueryForList<UMCodeValue>("GetMessage", parameter);
				request.Data = list;
				request.Result.Count = list.Count;
				return request;
			}
