...
{
	partial class BMCustomerBrandForm
	{
		/// <summary>
        ...
        "Name"};
			...
			this.txtBrandID.Location = new System.Drawing.Point(133, 97);
			...
			this.Name = "BMCustomerBrandForm";
			this.Text = "BMCustomerBrandForm";
