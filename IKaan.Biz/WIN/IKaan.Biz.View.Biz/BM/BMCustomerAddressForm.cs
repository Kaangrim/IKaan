...
{
	public partial class BMCustomerAddressForm : EditForm
	{
		public BMCustomerAddressForm()
		{
			InitializeComponent();
		...
		protected override void DataLoad(object param = null)
		{
			...
			try
			{
				...
				var model = WasHandler.GetData<BMCustomerAddress>("BM", "GetData", "Select", parameter);
				if (model == null)
		...
		{
			ClearControlData<BMCustomerAddress>();
			txtCustomerID.EditValue = (this.ParamsData as DataMap).GetValue("CustomerID");
			txtCustomerID.EditText = (this.ParamsData as DataMap).GetValue("CustomerName");
		...
		protected override void DataSave(object arg, SaveCallback callback)
		{
			try
			{
				var model = this.GetControlData<BMCustomerAddress>();
				
				using (var res = WasHandler.Execute<BMCustomerAddress>("BM", "Save", (this.EditMode == EditModeEnum.New) ? "Insert" : "Update", model, "ID"))
				{
		...
		protected override void DataDelete(object arg, DeleteCallback callback)
		{
			try
			{
				...
				using (var res = WasHandler.Execute<DataMap>("BM", "Delete", "DeleteBMCustomerAddress", map, "ID"))
				{
					if (res.Error.Number != 0)
						throw new Exception(res.Error.Message);
