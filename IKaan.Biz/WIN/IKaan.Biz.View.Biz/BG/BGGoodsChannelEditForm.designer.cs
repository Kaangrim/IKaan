...
{
	partial class BGGoodsChannelEditForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lupChannelAdmin = new IKaan.Biz.Core.Controls.Common.XLookup();
