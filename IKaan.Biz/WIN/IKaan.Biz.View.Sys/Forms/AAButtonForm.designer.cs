namespace IKaan.Biz.View.Sys.Forms
{
	partial class AAButtonForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.lupButtonType = new IKaan.Biz.Core.Controls.Common.XLookup();
			...
			this.lc.Controls.Add(this.txtButtonName);
			...
			// lcItemButtonName
			// 
			this.lcItemButtonName.Control = this.txtButtonName;
			...
			// txtButtonName
			// 
			this.txtButtonName.Location = new System.Drawing.Point(600, 35);
			this.txtButtonName.Name = "txtButtonName";
			this.txtButtonName.Size = new System.Drawing.Size(283, 20);
			this.txtButtonName.StyleController = this.lc;
			this.txtButtonName.TabIndex = 6;
			// 
			// emptySpaceItem1
			// 
			...
			this.Name = "AAButtonForm";
			this.Text = "AAButtonForm";
