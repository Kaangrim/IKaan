namespace IKaan.Biz.View.Sys.Forms
{
	partial class AAGroupForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.gridGroupRole = new IKaan.Biz.Core.Controls.Grid.XGrid();
			this.layoutControlItem1 = new DevExpress.XtraLayout.LayoutControlItem();
			this.gridGroupMenu = new IKaan.Biz.Core.Controls.Grid.XGrid();
			...
			this.lc.Controls.Add(this.txtGroupName);
			...
			// lcItemGroupName
			// 
			this.lcItemGroupName.Control = this.txtGroupName;
			...
			// txtGroupName
			// 
			this.txtGroupName.Location = new System.Drawing.Point(603, 35);
			this.txtGroupName.Name = "txtGroupName";
			this.txtGroupName.Size = new System.Drawing.Size(376, 20);
			this.txtGroupName.StyleController = this.lc;
			...
			this.gridGroupRole.GridViewType = IKaan.Biz.Core.Controls.Grid.GridViewType.GridView;
			...
			this.gridGroupMenu.GridViewType = IKaan.Biz.Core.Controls.Grid.GridViewType.GridView;
			...
			this.Name = "AAGroupForm";
			this.Text = "AAGroupForm";
