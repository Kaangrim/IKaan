...
{
	public partial class ADDatabaseForm : EditForm
	{
		public ADDatabaseForm()
		{
			InitializeComponent();
		...
		void InitGrid()
		{
			...
			gridList.AddGridColumns(
				...
				new XGridColumn() { FieldName = "DatabaseName", Width = 100 },
				new XGridColumn() { FieldName = "Description", Width = 200 },
				new XGridColumn() { FieldName = "DbmsTypeName", Width = 100, HorzAlignment = HorzAlignment.Center },
				new XGridColumn() { FieldName = "ServerName", Width = 100, HorzAlignment = HorzAlignment.Center },
		...
		protected override void DataLoad(object param = null)
		{
			...
			gridList.BindList<ADDatabase>("AD", "GetList", "Select", parameter);
		...
		void DetailDataLoad(object id)
		{
			try
			{
				var model = WasHandler.GetData<ADDatabase>("AD", "GetData", "Select", new DataMap() { { "ID", id } });
				if (model == null)
		...
		protected override void DataSave(object arg, SaveCallback callback)
		{
			try
			{
				var model = this.GetControlData<ADDatabase>();
				model.ServerID = lupServerID.EditValue.ToIntegerNullToZero();
				using (var res = WasHandler.Execute<ADDatabase>("AD", "Save", (this.EditMode == EditModeEnum.New) ? "Insert" : "Update", model, "ID"))
				{
		...
		protected override void DataDelete(object arg, DeleteCallback callback)
		{
			try
			{
				...
				using (var res = WasHandler.Execute<DataMap>("AA", "Delete", "DeleteADDatabase", map, "ID"))
				{
					if (res.Error.Number != 0)
						throw new Exception(res.Error.Message);
