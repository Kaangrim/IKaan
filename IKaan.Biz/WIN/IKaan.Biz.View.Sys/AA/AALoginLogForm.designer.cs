namespace IKaan.Biz.View.Sys.AA
{
	partial class AALoginLogForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.gridLogList = new IKaan.Biz.Core.Controls.Grid.XGrid();
			...
			this.gridLogList.GridViewType = IKaan.Biz.Core.Controls.Grid.GridViewType.GridView;
			...
			this.Name = "AALoginLogForm";
			this.Text = "AALoginLogForm";
