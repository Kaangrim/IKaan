namespace IKaan.Biz.View.Sys.AA
{
	partial class AAUserForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.lupUserType = new IKaan.Biz.Core.Controls.Common.XLookup();
			...
			this.gridUserGroup = new IKaan.Biz.Core.Controls.Grid.XGrid();
			this.lcGroupEdit3 = new DevExpress.XtraLayout.LayoutControlGroup();
			this.layoutControlItem2 = new DevExpress.XtraLayout.LayoutControlItem();
			this.gridUserRole = new IKaan.Biz.Core.Controls.Grid.XGrid();
			this.lcGroupEdit4 = new DevExpress.XtraLayout.LayoutControlGroup();
			this.layoutControlItem4 = new DevExpress.XtraLayout.LayoutControlItem();
			this.gridPasswordHistory = new IKaan.Biz.Core.Controls.Grid.XGrid();
			...
			this.gridUserGroup.GridViewType = IKaan.Biz.Core.Controls.Grid.GridViewType.GridView;
			...
			this.gridUserRole.GridViewType = IKaan.Biz.Core.Controls.Grid.GridViewType.GridView;
			...
			this.gridPasswordHistory.GridViewType = IKaan.Biz.Core.Controls.Grid.GridViewType.GridView;
		...
		private IKaan.Biz.Core.Controls.Common.XLookup lupUserType;
