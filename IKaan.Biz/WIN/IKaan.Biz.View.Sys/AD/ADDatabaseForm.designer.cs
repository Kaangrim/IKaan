namespace IKaan.Biz.View.Sys.AD
{
	partial class ADDatabaseForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.lupDbmsType = new IKaan.Biz.Core.Controls.Common.XLookup();
			...
			// txtDatabaseName
			// 
			this.txtDatabaseName.Location = new System.Drawing.Point(616, 35);
			...
			this.Name = "ADDatabaseForm";
			this.Text = "ADDatabaseForm";
