namespace IKaan.Win.View.Scrap.Common
{
	partial class ScrapEditForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.chkHideHtml = new DevExpress.XtraEditors.CheckEdit();
			...
			this.lcGroupHtml = new DevExpress.XtraLayout.LayoutControlGroup();
			this.lcItemScript = new DevExpress.XtraLayout.LayoutControlItem();
			this.memHtml = new DevExpress.XtraEditors.MemoEdit();
			this.lcGroupBrand = new DevExpress.XtraLayout.LayoutControlGroup();
			this.lcItemBrandInfo = new DevExpress.XtraLayout.LayoutControlItem();
			this.memBrandInfo = new DevExpress.XtraEditors.MemoEdit();
			this.lcItemBrandProgress = new DevExpress.XtraLayout.LayoutControlItem();
			...
			this.memProductInfo = new DevExpress.XtraEditors.MemoEdit();
			this.lcItemProductProgress = new DevExpress.XtraLayout.LayoutControlItem();
			this.progProducts = new DevExpress.XtraEditors.ProgressBarControl();
			...
			((System.ComponentModel.ISupportInitialize)(this.chkHideHtml.Properties)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.lcGroupHtml)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.lcItemScript)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.memHtml.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.lcGroupBrand)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.lcItemBrandInfo)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.memBrandInfo.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.lcItemBrandProgress)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.memProductInfo.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.lcItemProductProgress)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.progProducts.Properties)).BeginInit();
			...
			// lc
			// 
			this.lc.Controls.Add(this.chkHideHtml);
			...
			this.lc.Controls.Add(this.memImageInfo);
			this.lc.Controls.Add(this.progImages);
			this.lc.Controls.Add(this.memProductInfo);
			this.lc.Controls.Add(this.memBrandInfo);
			this.lc.Controls.Add(this.lupScrapSite);
			this.lc.Controls.Add(this.picImage);
			this.lc.Controls.Add(this.memHtml);
			this.lc.Controls.Add(this.progProducts);
			this.lc.Controls.Add(this.progSites);
			this.lc.Controls.Add(this.progBrands);
			...
			this.emptySpaceItem2.Size = new System.Drawing.Size(216, 142);
			...
			// chkOnlyBrand
			// 
			this.chkOnlyBrand.Location = new System.Drawing.Point(31, 242);
			...
			// chkOnlyProduct
			// 
			this.chkOnlyProduct.Location = new System.Drawing.Point(31, 265);
			...
			// btnDiffrenctSelect
			// 
			this.btnDiffrenctSelect.Location = new System.Drawing.Point(31, 288);
			...
			this.lcItemProductImagePath.Location = new System.Drawing.Point(0, 304);
			this.lcItemProductImagePath.Name = "lcItemProductImagePath";
			this.lcItemProductImagePath.Size = new System.Drawing.Size(216, 41);
			...
			// txtProductImagePath
			// 
			this.txtProductImagePath.Location = new System.Drawing.Point(31, 331);
			...
			// layoutControlItem7
			// 
			this.layoutControlItem7.Control = this.chkHideHtml;
			this.layoutControlItem7.Location = new System.Drawing.Point(0, 209);
			this.layoutControlItem7.Name = "layoutControlItem7";
			this.layoutControlItem7.Size = new System.Drawing.Size(216, 23);
			this.layoutControlItem7.TextSize = new System.Drawing.Size(0, 0);
			this.layoutControlItem7.TextVisible = false;
			// 
			// chkHideHtml
			// 
			this.chkHideHtml.Location = new System.Drawing.Point(31, 219);
			this.chkHideHtml.Name = "chkHideHtml";
			this.chkHideHtml.Properties.Caption = "HTML 숨기기";
			this.chkHideHtml.Size = new System.Drawing.Size(212, 19);
			this.chkHideHtml.StyleController = this.lc;
			this.chkHideHtml.TabIndex = 68;
			// 
			// gridSites
			// 
			this.gridSites.Compress = false;
			this.gridSites.DataSource = null;
			...
			this.gridSites.Location = new System.Drawing.Point(259, 35);
			this.gridSites.Name = "gridSites";
			this.gridSites.PageFooterCenter = null;
			this.gridSites.PageFooterLeft = null;
			this.gridSites.PageFooterRight = null;
			this.gridSites.PageHeaderCenter = null;
			this.gridSites.PageHeaderLeft = null;
			this.gridSites.PageHeaderRight = null;
			this.gridSites.Pager = null;
			this.gridSites.PrintFooter = null;
			this.gridSites.PrintHeader = null;
			this.gridSites.ReadOnly = false;
			this.gridSites.ShowFooter = false;
			this.gridSites.ShowGroupPanel = false;
			this.gridSites.Size = new System.Drawing.Size(330, 486);
			...
			this.progBrands.StyleController = this.lc;
			this.progBrands.TabIndex = 42;
			// 
			// lcGroupEditBase
			// 
			...
			this.lcGroupButtons.Size = new System.Drawing.Size(500, 36);
			...
			// lcGroupHtml
			// 
			this.lcGroupHtml.Items.AddRange(new DevExpress.XtraLayout.BaseLayoutItem[] {
            this.lcItemScript});
			this.lcGroupHtml.Location = new System.Drawing.Point(0, 36);
			this.lcGroupHtml.Name = "lcGroupHtml";
			this.lcGroupHtml.Padding = new DevExpress.XtraLayout.Utils.Padding(2, 2, 2, 2);
			this.lcGroupHtml.Size = new System.Drawing.Size(500, 71);
			this.lcGroupHtml.Text = "HTML";
			// 
			// lcItemScript
			// 
			this.lcItemScript.Control = this.memHtml;
			this.lcItemScript.Location = new System.Drawing.Point(0, 0);
			this.lcItemScript.MaxSize = new System.Drawing.Size(490, 0);
			this.lcItemScript.MinSize = new System.Drawing.Size(490, 20);
			this.lcItemScript.Name = "lcItemScript";
			this.lcItemScript.Size = new System.Drawing.Size(490, 42);
			this.lcItemScript.SizeConstraintsType = DevExpress.XtraLayout.SizeConstraintsType.Custom;
			...
			this.memHtml.TabIndex = 51;
			// 
			// lcGroupBrand
			// 
			this.lcGroupBrand.Items.AddRange(new DevExpress.XtraLayout.BaseLayoutItem[] {
            this.lcItemBrandInfo,
            this.lcItemBrandProgress});
			this.lcGroupBrand.Location = new System.Drawing.Point(0, 107);
			this.lcGroupBrand.Name = "lcGroupBrand";
			this.lcGroupBrand.Padding = new DevExpress.XtraLayout.Utils.Padding(2, 2, 2, 2);
			this.lcGroupBrand.Size = new System.Drawing.Size(500, 111);
			this.lcGroupBrand.Text = "Brand";
			// 
			// lcItemBrandInfo
			// 
			this.lcItemBrandInfo.Control = this.memBrandInfo;
			this.lcItemBrandInfo.Location = new System.Drawing.Point(0, 0);
			this.lcItemBrandInfo.MaxSize = new System.Drawing.Size(0, 60);
			this.lcItemBrandInfo.MinSize = new System.Drawing.Size(89, 60);
			this.lcItemBrandInfo.Name = "lcItemBrandInfo";
			this.lcItemBrandInfo.Size = new System.Drawing.Size(490, 60);
			this.lcItemBrandInfo.SizeConstraintsType = DevExpress.XtraLayout.SizeConstraintsType.Custom;
			this.lcItemBrandInfo.Text = "브랜드정보";
			this.lcItemBrandInfo.TextLocation = DevExpress.Utils.Locations.Top;
			this.lcItemBrandInfo.TextSize = new System.Drawing.Size(0, 0);
			this.lcItemBrandInfo.TextVisible = false;
			// 
			// memBrandInfo
			// 
			...
			this.memBrandInfo.TabIndex = 54;
			// 
			// lcItemBrandProgress
			// 
			this.lcItemBrandProgress.Control = this.progBrands;
			this.lcItemBrandProgress.Location = new System.Drawing.Point(0, 60);
			this.lcItemBrandProgress.Name = "lcItemBrandProgress";
			this.lcItemBrandProgress.Size = new System.Drawing.Size(490, 22);
			this.lcItemBrandProgress.TextSize = new System.Drawing.Size(0, 0);
			this.lcItemBrandProgress.TextVisible = false;
			// 
			// lcGroupProduct
			// 
			this.lcGroupProduct.Items.AddRange(new DevExpress.XtraLayout.BaseLayoutItem[] {
            this.lcItemProduct,
            this.lcItemProductProgress});
			this.lcGroupProduct.Location = new System.Drawing.Point(0, 218);
			this.lcGroupProduct.Name = "lcGroupProduct";
			this.lcGroupProduct.Padding = new DevExpress.XtraLayout.Utils.Padding(2, 2, 2, 2);
			this.lcGroupProduct.Size = new System.Drawing.Size(500, 111);
			this.lcGroupProduct.Text = "Product";
			// 
			// lcItemProduct
			// 
			this.lcItemProduct.Control = this.memProductInfo;
			this.lcItemProduct.Location = new System.Drawing.Point(0, 0);
			this.lcItemProduct.MaxSize = new System.Drawing.Size(0, 60);
			this.lcItemProduct.MinSize = new System.Drawing.Size(89, 60);
			this.lcItemProduct.Name = "lcItemProduct";
			this.lcItemProduct.Size = new System.Drawing.Size(490, 60);
			this.lcItemProduct.SizeConstraintsType = DevExpress.XtraLayout.SizeConstraintsType.Custom;
			this.lcItemProduct.Text = "상품정보";
			this.lcItemProduct.TextLocation = DevExpress.Utils.Locations.Top;
			this.lcItemProduct.TextSize = new System.Drawing.Size(0, 0);
			this.lcItemProduct.TextVisible = false;
			// 
			// memProductInfo
			// 
			...
			this.memProductInfo.TabIndex = 55;
			// 
			// lcItemProductProgress
			// 
			this.lcItemProductProgress.Control = this.progProducts;
			this.lcItemProductProgress.Location = new System.Drawing.Point(0, 60);
			this.lcItemProductProgress.Name = "lcItemProductProgress";
			this.lcItemProductProgress.Size = new System.Drawing.Size(490, 22);
			this.lcItemProductProgress.TextSize = new System.Drawing.Size(0, 0);
			this.lcItemProductProgress.TextVisible = false;
			// 
			// progProducts
			// 
			...
			this.progProducts.StyleController = this.lc;
			this.progProducts.TabIndex = 49;
			// 
			// lcGroupImage
			// 
			...
			this.lcGroupImage.Size = new System.Drawing.Size(500, 219);
			...
			this.lcItemImage.MaxSize = new System.Drawing.Size(168, 168);
			this.lcItemImage.MinSize = new System.Drawing.Size(168, 168);
			this.lcItemImage.Name = "lcItemImage";
			this.lcItemImage.Size = new System.Drawing.Size(168, 168);
			this.lcItemImage.SizeConstraintsType = DevExpress.XtraLayout.SizeConstraintsType.Custom;
			this.lcItemImage.Text = "상품이미지";
			this.lcItemImage.TextLocation = DevExpress.Utils.Locations.Top;
			...
			this.picImage.Size = new System.Drawing.Size(164, 164);
			...
			this.lcItemImageInfo.TextVisible = false;
			// 
			// memImageInfo
			// 
			...
			// lcItemImageProgress
			// 
			this.lcItemImageProgress.Control = this.progImages;
			this.lcItemImageProgress.Location = new System.Drawing.Point(0, 168);
			this.lcItemImageProgress.Name = "lcItemImageProgress";
			this.lcItemImageProgress.Size = new System.Drawing.Size(490, 22);
			this.lcItemImageProgress.TextSize = new System.Drawing.Size(0, 0);
			this.lcItemImageProgress.TextVisible = false;
			// 
			// progImages
			// 
			...
			// lcTabGroupBrand
			// 
			this.lcTabGroupBrand.CaptionImage = ((System.Drawing.Image)(resources.GetObject("lcTabGroupBrand.CaptionImage")));
			...
			this.lcTabGroupBrand.Size = new System.Drawing.Size(334, 512);
			...
			this.layoutControlItem4.Size = new System.Drawing.Size(334, 512);
			...
			this.gridBrands.Size = new System.Drawing.Size(330, 508);
			this.gridBrands.TabIndex = 61;
			// 
			// lcTabGroupSiteUrl
			// 
			this.lcTabGroupSiteUrl.CaptionImage = ((System.Drawing.Image)(resources.GetObject("lcTabGroupSiteUrl.CaptionImage")));
			...
			this.lcTabGroupSiteUrl.Size = new System.Drawing.Size(334, 512);
			...
			this.lcGridList.Size = new System.Drawing.Size(334, 490);
			...
			this.lcItemProgList.Location = new System.Drawing.Point(0, 490);
			...
			((System.ComponentModel.ISupportInitialize)(this.chkHideHtml.Properties)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.lcGroupHtml)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.lcItemScript)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.memHtml.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.lcGroupBrand)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.lcItemBrandInfo)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.memBrandInfo.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.lcItemBrandProgress)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.memProductInfo.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.lcItemProductProgress)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.progProducts.Properties)).EndInit();
		...
		private DevExpress.XtraEditors.MemoEdit memBrandInfo;
		private DevExpress.XtraLayout.LayoutControlGroup lcGroupHtml;
		private DevExpress.XtraEditors.MemoEdit memProductInfo;
		private DevExpress.XtraEditors.MemoEdit memImageInfo;
		private DevExpress.XtraEditors.ProgressBarControl progImages;
		private DevExpress.XtraLayout.LayoutControlGroup lcGroupBrand;
		private DevExpress.XtraLayout.LayoutControlItem lcItemBrandInfo;
		private DevExpress.XtraLayout.LayoutControlItem lcItemBrandProgress;
		...
		private DevExpress.XtraLayout.LayoutControlItem lcItemProductProgress;
		...
		private DevExpress.XtraLayout.LayoutControlItem lcItemImageProgress;
		private DevExpress.XtraEditors.CheckEdit chkImageView;
		private DevExpress.XtraLayout.LayoutControlItem layoutControlItem1;
		private DevExpress.XtraEditors.CheckEdit chkErrorHide;
		...
		private DevExpress.XtraEditors.CheckEdit chkHideHtml;
