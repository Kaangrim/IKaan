	...
	public partial class BrandManagerEditForm : EditForm
	{
		...
		protected override void DataLoad(object param = null)
		{
			...
			try
			{
				...
				var model = WasHandler.GetData<BrandManagerModel>("Biz", "GetData", "Select", parameter);
				if (model == null)
		...
		protected override void DataSave(object arg, SaveCallback callback)
		{
			try
			{
				var model = this.GetControlData<BrandManagerModel>();

				using (var res = WasHandler.Execute<BrandManagerModel>("Biz", "Save", (this.EditMode == EditModeEnum.New) ? "Insert" : "Update", model, "ID"))
				{
