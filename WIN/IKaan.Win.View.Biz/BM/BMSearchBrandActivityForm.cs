...
{
	public partial class BMSearchBrandActivityForm : EditForm
	{
		public BMSearchBrandActivityForm()
		{
			InitializeComponent();
		}
		...
		protected override void DataLoad(object param = null)
		{
			...
			try
			{
				...
				var model = WasHandler.GetData<BMSearchBrandActivity>("BM", "GetData", "Select", parameter);
				if (model == null)
		...
		protected override void DataDelete(object arg, DeleteCallback callback)
		{
			try
			{
				...
				using (var res = WasHandler.Execute<DataMap>("BM", "Delete", "DeleteBMSearchBrandActivity", map, "ID"))
				{
					if (res.Error.Number != 0)
						throw new Exception(res.Error.Message);
