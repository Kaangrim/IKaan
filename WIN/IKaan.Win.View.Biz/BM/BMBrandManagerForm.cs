...
{
	public partial class BMBrandManagerForm : EditForm
	{
		public BMBrandManagerForm()
		{
			InitializeComponent();
		}
		...
		protected override void DataLoad(object param = null)
		{
			...
			try
			{
				...
				var model = WasHandler.GetData<BMBrandManager>("BM", "GetData", "Select", parameter);
				if (model == null)
		...
		{
			ClearControlData<BMBrandManager>();
		...
		protected override void DataSave(object arg, SaveCallback callback)
		{
			try
			{
				var model = this.GetControlData<BMBrandManager>();

				using (var res = WasHandler.Execute<BMBrandManager>("BM", "Save", (this.EditMode == EditModeEnum.New) ? "Insert" : "Update", model, "ID"))
				{
		...
		protected override void DataDelete(object arg, DeleteCallback callback)
		{
			try
			{
				...
				using (var res = WasHandler.Execute<DataMap>("BM", "Delete", "DeleteBMBrandManager", map, "ID"))
				{
					if (res.Error.Number != 0)
						throw new Exception(res.Error.Message);
