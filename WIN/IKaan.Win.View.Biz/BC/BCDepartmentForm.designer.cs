namespace IKaan.Win.View.Biz.BC
{
	partial class BCDepartmentForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtManagerID = new IKaan.Win.Core.Controls.Common.XSearch();
			...
			this.gridHistory = new IKaan.Win.Core.Controls.Grid.XGrid();
        ...
        "NAME"};
			...
			this.gridHistory.GridViewType = IKaan.Win.Core.Controls.Grid.GridViewType.GridView;
