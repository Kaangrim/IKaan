...
{
	public partial class ChannelContactEditForm : EditForm
	{
		public ChannelContactEditForm()
		{
			InitializeComponent();
		}
		...
		protected override void DataLoad(object param = null)
		{
			...
			try
			{
				...
				var model = WasHandler.GetData<ChannelContactModel>("Biz", "GetData", "Select", parameter);
				if (model == null)
		...
		{
			ClearControlData<ChannelContactModel>();
			txtChannelID.EditValue = (this.ParamsData as DataMap).GetValue("ChannelID");
			txtChannelID.EditText = (this.ParamsData as DataMap).GetValue("ChannelName");
		...
		protected override void DataSave(object arg, SaveCallback callback)
		{
			try
			{
				var model = this.GetControlData<ChannelContactModel>();

				using (var res = WasHandler.Execute<ChannelContactModel>("Biz", "Save", (this.EditMode == EditModeEnum.New) ? "Insert" : "Update", model, "ID"))
				{
