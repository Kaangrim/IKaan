namespace IKaan.Win.View.Biz.Master.Contact
{
	partial class ContactListForm
	{
		...
		private void InitializeComponent()
		{
			...
			((System.ComponentModel.ISupportInitialize)(this.lcItemContactType)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.lupContactType.Properties)).BeginInit();
			...
			this.lc.Controls.Add(this.lupContactType);
			...
			// lcItemContactType
			// 
			this.lcItemContactType.Control = this.lupContactType;
			this.lcItemContactType.Location = new System.Drawing.Point(0, 81);
			this.lcItemContactType.Name = "lcItemContactType";
			this.lcItemContactType.Size = new System.Drawing.Size(216, 41);
			this.lcItemContactType.TextLocation = DevExpress.Utils.Locations.Top;
			this.lcItemContactType.TextSize = new System.Drawing.Size(105, 14);
			// 
			// lupContactType
			// 
			this.lupContactType.DisplayMember = "";
			this.lupContactType.GroupCode = null;
			this.lupContactType.ListMember = "ListName";
			this.lupContactType.Location = new System.Drawing.Point(31, 108);
			this.lupContactType.Name = "lupContactType";
			this.lupContactType.NullText = "[EditValue is null]";
			this.lupContactType.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
			...
			this.lupContactType.SelectedIndex = -1;
			this.lupContactType.Size = new System.Drawing.Size(212, 20);
			this.lupContactType.StyleController = this.lc;
			this.lupContactType.TabIndex = 43;
			this.lupContactType.ValueMember = "";
			// 
			// emptySpaceItem1
			// 
			...
			((System.ComponentModel.ISupportInitialize)(this.lcItemContactType)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.lupContactType.Properties)).EndInit();
		...
		private Core.Controls.Common.XLookup lupContactType;
		private DevExpress.XtraLayout.LayoutControlItem lcItemContactType;
