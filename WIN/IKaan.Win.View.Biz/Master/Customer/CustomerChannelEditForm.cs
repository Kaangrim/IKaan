...
{
	public partial class CustomerChannelEditForm : EditForm
	{
		public CustomerChannelEditForm()
		{
			InitializeComponent();
		}
		...
		protected override void DataDelete(object arg, DeleteCallback callback)
		{
			try
			{
				using (var res = WasHandler.Execute<DataMap>("Biz", "Delete", "DeleteCustomerChannel", new DataMap() { { "ID", txtID.EditValue } }, "ID"))
				{
					if (res.Error.Number != 0)
						throw new Exception(res.Error.Message);
