...
{
	partial class AttributeTypeEditForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lupValueType = new IKaan.Win.Core.Controls.Common.XLookup();
			this.lcItemValueType = new DevExpress.XtraLayout.LayoutControlItem();
			...
			((System.ComponentModel.ISupportInitialize)(this.lupValueType.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.lcItemValueType)).BeginInit();
			this.SuspendLayout();
			// 
			// lc
			// 
			this.lc.Controls.Add(this.lupValueType);
			...
			// lupValueType
			// 
			this.lupValueType.DisplayMember = "";
			this.lupValueType.GroupCode = null;
			this.lupValueType.ListMember = "ListName";
			this.lupValueType.Location = new System.Drawing.Point(140, 83);
			this.lupValueType.Name = "lupValueType";
			this.lupValueType.NullText = "[EditValue is null]";
			this.lupValueType.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
			...
			this.lupValueType.SelectedIndex = -1;
			this.lupValueType.Size = new System.Drawing.Size(347, 20);
			this.lupValueType.StyleController = this.lc;
			this.lupValueType.TabIndex = 46;
			this.lupValueType.ValueMember = "";
			// 
			// lcItemValueType
			// 
			this.lcItemValueType.Control = this.lupValueType;
			this.lcItemValueType.Location = new System.Drawing.Point(0, 72);
			this.lcItemValueType.Name = "lcItemValueType";
			this.lcItemValueType.Size = new System.Drawing.Size(480, 24);
			this.lcItemValueType.TextSize = new System.Drawing.Size(125, 14);
			// 
			// AttributeTypeEditForm
			// 
			...
			this.Name = "AttributeTypeEditForm";
			this.Text = "AttributeTypeEditForm";
			...
			((System.ComponentModel.ISupportInitialize)(this.lupValueType.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.lcItemValueType)).EndInit();
		...
		private Core.Controls.Common.XLookup lupValueType;
		private DevExpress.XtraLayout.LayoutControlItem lcItemValueType;
	}
}