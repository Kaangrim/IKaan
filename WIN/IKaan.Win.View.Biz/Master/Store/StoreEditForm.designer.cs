namespace IKaan.Win.View.Biz.Master.Store
{
	partial class StoreEditForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.lcItemStoreType = new DevExpress.XtraLayout.LayoutControlItem();
			this.lupStoreType = new IKaan.Win.Core.Controls.Common.XLookup();
			this.lcItemName = new DevExpress.XtraLayout.LayoutControlItem();
			this.txtName = new DevExpress.XtraEditors.TextEdit();
			this.lcItemHosts = new DevExpress.XtraLayout.LayoutControlItem();
			this.txtHosts = new DevExpress.XtraEditors.TextEdit();
			...
			((System.ComponentModel.ISupportInitialize)(this.lcItemStoreType)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.lupStoreType.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.lcItemName)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.txtName.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.lcItemHosts)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.txtHosts.Properties)).BeginInit();
			...
			this.lc.Controls.Add(this.txtHosts);
			this.lc.Controls.Add(this.lupStoreType);
			...
			this.lc.OptionsCustomizationForm.DesignTimeCustomizationFormPositionAndSize = new System.Drawing.Rectangle(1285, 231, 457, 350);
			this.lc.OptionsView.UseDefaultDragAndDropRendering = false;
			this.lc.Padding = new System.Windows.Forms.Padding(2);
			this.lc.Size = new System.Drawing.Size(798, 302);
			// 
			// lcGroupBase
			// 
			...
			this.lcGroupBase.Size = new System.Drawing.Size(798, 302);
			// 
			// lcGroupEdit1
			// 
			...
			this.lcGroupEdit1.Size = new System.Drawing.Size(550, 236);
			...
			this.lcItemID.Size = new System.Drawing.Size(536, 24);
			...
			this.lcItemUseYn.Size = new System.Drawing.Size(536, 23);
			...
			this.lcItemUrl.Size = new System.Drawing.Size(536, 24);
			...
			this.lcItemDescription.Size = new System.Drawing.Size(536, 79);
			...
			this.memDescription.Size = new System.Drawing.Size(403, 75);
			this.memDescription.StyleController = this.lc;
			this.memDescription.TabIndex = 14;
			// 
			// lcItemStoreType
			// 
			this.lcItemStoreType.Control = this.lupStoreType;
			this.lcItemStoreType.Location = new System.Drawing.Point(0, 48);
			this.lcItemStoreType.Name = "lcItemStoreType";
			this.lcItemStoreType.Size = new System.Drawing.Size(536, 24);
			this.lcItemStoreType.TextSize = new System.Drawing.Size(125, 14);
			// 
			// lupStoreType
			// 
			this.lupStoreType.DisplayMember = "";
			this.lupStoreType.GroupCode = null;
			this.lupStoreType.ListMember = "ListName";
			this.lupStoreType.Location = new System.Drawing.Point(140, 59);
			this.lupStoreType.Name = "lupStoreType";
			this.lupStoreType.NullText = "[EditValue is null]";
			this.lupStoreType.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
			...
			this.lupStoreType.SelectedIndex = -1;
			this.lupStoreType.Size = new System.Drawing.Size(403, 20);
			this.lupStoreType.StyleController = this.lc;
			this.lupStoreType.TabIndex = 43;
			this.lupStoreType.ValueMember = "";
			// 
			// lcItemName
			// 
			...
			this.lcItemName.Size = new System.Drawing.Size(536, 24);
			...
			// lcItemHosts
			// 
			this.lcItemHosts.Control = this.txtHosts;
			this.lcItemHosts.Location = new System.Drawing.Point(0, 96);
			this.lcItemHosts.Name = "lcItemHosts";
			this.lcItemHosts.Size = new System.Drawing.Size(536, 24);
			this.lcItemHosts.TextSize = new System.Drawing.Size(125, 14);
			// 
			// txtHosts
			// 
			this.txtHosts.Location = new System.Drawing.Point(140, 107);
			this.txtHosts.Name = "txtHosts";
			this.txtHosts.Size = new System.Drawing.Size(403, 20);
			this.txtHosts.StyleController = this.lc;
			this.txtHosts.TabIndex = 44;
			// 
			// lcGroupRegInfo
			// 
			...
			this.lcGroupRegInfo.Size = new System.Drawing.Size(550, 62);
			...
			this.lcItemCreatedOn.Size = new System.Drawing.Size(268, 24);
			...
			this.txtCreatedOn.Size = new System.Drawing.Size(135, 20);
			...
			this.lcItemCreatedByName.Size = new System.Drawing.Size(268, 24);
			...
			this.txtCreatedByName.Size = new System.Drawing.Size(135, 20);
			...
			this.lcItemUpdatedOn.Location = new System.Drawing.Point(268, 0);
			this.lcItemUpdatedOn.Name = "lcItemUpdatedOn";
			this.lcItemUpdatedOn.Size = new System.Drawing.Size(268, 24);
			this.lcItemUpdatedOn.TextSize = new System.Drawing.Size(125, 14);
			// 
			// txtUpdatedOn
			// 
			this.txtUpdatedOn.Location = new System.Drawing.Point(408, 247);
			...
			this.lcItemUpdatedByName.Location = new System.Drawing.Point(268, 24);
			this.lcItemUpdatedByName.Name = "lcItemUpdatedByName";
			this.lcItemUpdatedByName.Size = new System.Drawing.Size(268, 24);
			this.lcItemUpdatedByName.TextSize = new System.Drawing.Size(125, 14);
			// 
			// txtUpdatedByName
			// 
			this.txtUpdatedByName.Location = new System.Drawing.Point(408, 271);
			...
			this.lcGroupEditBase.Size = new System.Drawing.Size(550, 298);
			...
			this.layoutControlItem1.Size = new System.Drawing.Size(230, 284);
			...
			((System.ComponentModel.ISupportInitialize)(this.lcItemStoreType)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.lupStoreType.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.lcItemName)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.txtName.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.lcItemHosts)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.txtHosts.Properties)).EndInit();
		...
		private Core.Controls.Common.XLookup lupStoreType;
		private DevExpress.XtraLayout.LayoutControlItem lcItemStoreType;
		private DevExpress.XtraEditors.TextEdit txtHosts;
		private DevExpress.XtraLayout.LayoutControlItem lcItemHosts;
