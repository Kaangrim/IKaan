...
namespace IKaan.Win.View.Biz.Brand
{
	public partial class BrandEditForm : EditForm
	{
		...
		protected override void InitControls()
		{
			...
			lcItemFindCategory.SetFieldName("BrandCategory");
			lcItemStyle.SetFieldName("BrandStyle");
			lcItemFindStyle.SetFieldName("BrandStyle");
			...
			lupFindCategory.BindData("BrandCategory", "All");
			lupFindStyle.BindData("BrandStyle", "All");
