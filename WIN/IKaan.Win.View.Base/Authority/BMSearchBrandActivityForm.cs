...
{
	public partial class TSearchBrandActivityForm : EditForm
	{
		public TSearchBrandActivityForm()
		{
			InitializeComponent();
		}
		...
		protected override void DataLoad(object param = null)
		{
			...
			try
			{
				...
				var model = WasHandler.GetData<SearchBrandActivityModel>("BM", "GetData", "Select", parameter);
				if (model == null)
		...
		{
			ClearControlData<BrandManagerModel>();
		...
		protected override void DataSave(object arg, SaveCallback callback)
		{
			try
			{
				...
				using (var res = WasHandler.Execute<SearchBrandActivityModel>("BM", "Save", (this.EditMode == EditModeEnum.New) ? "Insert" : "Update", model, "ID"))
				{
		...
		protected override void DataDelete(object arg, DeleteCallback callback)
		{
			try
			{
				...
				using (var res = WasHandler.Execute<DataMap>("BM", "Delete", "DeleteTSearchBrandActivity", map, "ID"))
				{
					if (res.Error.Number != 0)
						throw new Exception(res.Error.Message);
