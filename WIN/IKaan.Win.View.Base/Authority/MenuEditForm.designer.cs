namespace IKaan.Win.View.Base.Authority
{
	partial class MenuEditForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.lcItemMenuType = new DevExpress.XtraLayout.LayoutControlItem();
			this.lupMenuType = new IKaan.Win.Core.Controls.Common.XLookup();
			...
			this.lcItemViewID = new DevExpress.XtraLayout.LayoutControlItem();
			this.lupViewID = new IKaan.Win.Core.Controls.Common.XLookup();
			this.lcItemParameter = new DevExpress.XtraLayout.LayoutControlItem();
			this.txtParameter = new DevExpress.XtraEditors.TextEdit();
			this.lupMenuGroup = new IKaan.Win.Core.Controls.Common.XLookup();
			...
			((System.ComponentModel.ISupportInitialize)(this.lcItemMenuType)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.lupMenuType.Properties)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.lcItemViewID)).BeginInit();
			...
			this.lc.Controls.Add(this.lupMenuType);
			this.lc.Controls.Add(this.txtMenuPath);
			this.lc.Controls.Add(this.numSortOrder);
			...
			// txtCreatedOn
			// 
			this.txtCreatedOn.Location = new System.Drawing.Point(594, 354);
			this.txtCreatedOn.Name = "txtCreatedOn";
			this.txtCreatedOn.Size = new System.Drawing.Size(129, 20);
			...
			// txtCreatedByName
			// 
			this.txtCreatedByName.Location = new System.Drawing.Point(594, 378);
			this.txtCreatedByName.Name = "txtCreatedByName";
			this.txtCreatedByName.Size = new System.Drawing.Size(129, 20);
			...
			this.lcItemUpdatedOn.Size = new System.Drawing.Size(256, 24);
			this.lcItemUpdatedOn.TextSize = new System.Drawing.Size(118, 14);
			// 
			// txtUpdatedOn
			// 
			this.txtUpdatedOn.Location = new System.Drawing.Point(849, 354);
			...
			this.lcItemUpdatedByName.Size = new System.Drawing.Size(256, 24);
			this.lcItemUpdatedByName.TextSize = new System.Drawing.Size(118, 14);
			// 
			// txtUpdatedByName
			// 
			this.txtUpdatedByName.Location = new System.Drawing.Point(849, 378);
			...
			((System.ComponentModel.ISupportInitialize)(this.lcItemMenuType)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.lupMenuType.Properties)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.lcItemViewID)).EndInit();
		...
		private DevExpress.XtraEditors.SpinEdit numSortOrder;
		...
		private IKaan.Win.Core.Controls.Common.XLookup lupMenuType;
		private DevExpress.XtraLayout.LayoutControlItem lcItemMenuType;
