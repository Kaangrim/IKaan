...
{
	public partial class BookmarkEditForm : EditForm
	{
		...
		{
			gridList.BindList<BookmarkUserModel>("Base", "GetList", "Select", new DataMap() { { "FindText", txtFindText.EditValue } });
		...
		void DetailDataLoad(object id)
		{
			try
			{
				var list = WasHandler.GetList<BookmarkModel>("Base", "GetList", "Select", new DataMap() { { "ID", id } });
		...
		protected override void DataSave(object arg, SaveCallback callback)
		{
			try
			{
				var model = this.GetControlData<BookmarkModel>();
				using (var res = WasHandler.Execute<BookmarkModel>("Base", "Save", (this.EditMode == EditModeEnum.New) ? "Insert" : "Update", model, "ID"))
				{
