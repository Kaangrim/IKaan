namespace IKaan.Win.View.Base.Authority
{
	partial class GroupEditForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.lcItemGroupName = new DevExpress.XtraLayout.LayoutControlItem();
			this.txGroupModelName = new DevExpress.XtraEditors.TextEdit();
			...
			this.gridGroupRole = new IKaan.Win.Core.Controls.Grid.XGrid();
			this.layoutControlItem1 = new DevExpress.XtraLayout.LayoutControlItem();
			this.gridGroupMenu = new IKaan.Win.Core.Controls.Grid.XGrid();
			...
			((System.ComponentModel.ISupportInitialize)(this.lcItemGroupName)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.txGroupModelName.Properties)).BeginInit();
			...
			// lc
			// 
			this.lc.Controls.Add(this.gridGroupMenu);
			this.lc.Controls.Add(this.gridGroupRole);
			this.lc.Controls.Add(this.txGroupModelName);
			...
			this.lcGroupEdit1.Size = new System.Drawing.Size(516, 209);
			...
			// memDescription
			// 
			this.memDescription.Location = new System.Drawing.Point(603, 106);
			...
			this.lcItemUseYn.Size = new System.Drawing.Size(502, 23);
			this.lcItemUseYn.TextSize = new System.Drawing.Size(118, 14);
			// 
			// chkUseYn
			// 
			this.chkUseYn.EditValue = "N";
			this.chkUseYn.Location = new System.Drawing.Point(603, 83);
			...
			this.lcItemParentID.Size = new System.Drawing.Size(502, 24);
			...
			this.lupParentID.Location = new System.Drawing.Point(603, 59);
			...
			this.lupParentID.Size = new System.Drawing.Size(376, 20);
			...
			// lcItemGroupName
			// 
			this.lcItemGroupName.Control = this.txGroupModelName;
			this.lcItemGroupName.Location = new System.Drawing.Point(0, 24);
			this.lcItemGroupName.Name = "lcItemGroupName";
			this.lcItemGroupName.Size = new System.Drawing.Size(502, 24);
			this.lcItemGroupName.TextSize = new System.Drawing.Size(118, 14);
			// 
			// txGroupModelName
			// 
			this.txGroupModelName.Location = new System.Drawing.Point(603, 35);
			this.txGroupModelName.Name = "txGroupModelName";
			this.txGroupModelName.Size = new System.Drawing.Size(376, 20);
			this.txGroupModelName.StyleController = this.lc;
			this.txGroupModelName.TabIndex = 23;
			// 
			// splitterItem1
			// 
			...
			this.lcGroupRegInfo.Location = new System.Drawing.Point(0, 209);
			...
			// txtCreatedOn
			// 
			this.txtCreatedOn.Location = new System.Drawing.Point(603, 220);
			this.txtCreatedOn.Name = "txtCreatedOn";
			this.txtCreatedOn.Size = new System.Drawing.Size(125, 20);
			...
			// txtCreatedByName
			// 
			this.txtCreatedByName.Location = new System.Drawing.Point(603, 244);
			this.txtCreatedByName.Name = "txtCreatedByName";
			this.txtCreatedByName.Size = new System.Drawing.Size(125, 20);
			...
			// txtUpdatedOn
			// 
			this.txtUpdatedOn.Location = new System.Drawing.Point(854, 220);
			...
			// txtUpdatedByName
			// 
			this.txtUpdatedByName.Location = new System.Drawing.Point(854, 244);
			...
			this.tabbedControlGroup1.Size = new System.Drawing.Size(516, 224);
			...
			this.lcGroupEdit2.Size = new System.Drawing.Size(506, 190);
			this.lcGroupEdit2.Text = "권한그룹";
			// 
			// lcGroupEdit3
			// 
			...
			this.lcGroupEdit3.Size = new System.Drawing.Size(506, 190);
			this.lcGroupEdit3.Text = "메뉴설정";
			// 
			// gridGroupRole
			// 
			this.gridGroupRole.Compress = false;
			this.gridGroupRole.DataSource = null;
			this.gridGroupRole.Editable = true;
			this.gridGroupRole.FocusedRowHandle = -2147483648;
			this.gridGroupRole.GridViewType = IKaan.Win.Core.Controls.Grid.GridViewType.GridView;
			this.gridGroupRole.Location = new System.Drawing.Point(479, 304);
			this.gridGroupRole.Name = "gridGroupRole";
			this.gridGroupRole.PageFooterCenter = null;
			this.gridGroupRole.PageFooterLeft = null;
			this.gridGroupRole.PageFooterRight = null;
			this.gridGroupRole.PageHeaderCenter = null;
			this.gridGroupRole.PageHeaderLeft = null;
			this.gridGroupRole.PageHeaderRight = null;
			this.gridGroupRole.Pager = null;
			this.gridGroupRole.PrintFooter = null;
			this.gridGroupRole.PrintHeader = null;
			this.gridGroupRole.ReadOnly = false;
			this.gridGroupRole.ShowFooter = false;
			this.gridGroupRole.ShowGroupPanel = false;
			this.gridGroupRole.Size = new System.Drawing.Size(502, 186);
			this.gridGroupRole.TabIndex = 24;
			// 
			// layoutControlItem1
			// 
			this.layoutControlItem1.Control = this.gridGroupRole;
			this.layoutControlItem1.Location = new System.Drawing.Point(0, 0);
			this.layoutControlItem1.Name = "layoutControlItem1";
			this.layoutControlItem1.Size = new System.Drawing.Size(506, 190);
			this.layoutControlItem1.TextSize = new System.Drawing.Size(0, 0);
			this.layoutControlItem1.TextVisible = false;
			// 
			// gridGroupMenu
			// 
			this.gridGroupMenu.Compress = false;
			this.gridGroupMenu.DataSource = null;
			this.gridGroupMenu.Editable = true;
			this.gridGroupMenu.FocusedRowHandle = -2147483648;
			this.gridGroupMenu.GridViewType = IKaan.Win.Core.Controls.Grid.GridViewType.GridView;
			this.gridGroupMenu.Location = new System.Drawing.Point(479, 304);
			this.gridGroupMenu.Name = "gridGroupMenu";
			this.gridGroupMenu.PageFooterCenter = null;
			this.gridGroupMenu.PageFooterLeft = null;
			this.gridGroupMenu.PageFooterRight = null;
			this.gridGroupMenu.PageHeaderCenter = null;
			this.gridGroupMenu.PageHeaderLeft = null;
			this.gridGroupMenu.PageHeaderRight = null;
			this.gridGroupMenu.Pager = null;
			this.gridGroupMenu.PrintFooter = null;
			this.gridGroupMenu.PrintHeader = null;
			this.gridGroupMenu.ReadOnly = false;
			this.gridGroupMenu.ShowFooter = false;
			this.gridGroupMenu.ShowGroupPanel = false;
			this.gridGroupMenu.Size = new System.Drawing.Size(502, 186);
			this.gridGroupMenu.TabIndex = 25;
			// 
			// layoutControlItem2
			// 
			this.layoutControlItem2.Control = this.gridGroupMenu;
			this.layoutControlItem2.Location = new System.Drawing.Point(0, 0);
			this.layoutControlItem2.Name = "layoutControlItem2";
			this.layoutControlItem2.Size = new System.Drawing.Size(506, 190);
			...
			((System.ComponentModel.ISupportInitialize)(this.lcItemGroupName)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.txGroupModelName.Properties)).EndInit();
		...
		private DevExpress.XtraEditors.TextEdit txGroupModelName;
		private DevExpress.XtraLayout.LayoutControlItem lcItemGroupName;
		...
		private Core.Controls.Grid.XGrid gridGroupRole;
		private DevExpress.XtraLayout.LayoutControlItem layoutControlItem1;
		private Core.Controls.Grid.XGrid gridGroupMenu;
