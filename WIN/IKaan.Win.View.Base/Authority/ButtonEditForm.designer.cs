namespace IKaan.Win.View.Base.Authority
{
	partial class ButtonEditForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.lcItemButtonName = new DevExpress.XtraLayout.LayoutControlItem();
			this.txButtonModelName = new DevExpress.XtraEditors.TextEdit();
			...
			this.lupButtonType = new IKaan.Win.Core.Controls.Common.XLookup();
			this.lcItemButtonType = new DevExpress.XtraLayout.LayoutControlItem();
			...
			((System.ComponentModel.ISupportInitialize)(this.lcItemButtonName)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.txButtonModelName.Properties)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.lupButtonType.Properties)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.lcItemButtonType)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.emptySpaceItem4)).BeginInit();
			this.SuspendLayout();
			// 
			// lc
			// 
			this.lc.Controls.Add(this.lupButtonType);
			...
			this.lc.Controls.Add(this.txButtonModelName);
			...
			// lcItemButtonName
			// 
			this.lcItemButtonName.Control = this.txButtonModelName;
			this.lcItemButtonName.Location = new System.Drawing.Point(0, 24);
			this.lcItemButtonName.Name = "lcItemButtonName";
			this.lcItemButtonName.Size = new System.Drawing.Size(409, 24);
			this.lcItemButtonName.TextSize = new System.Drawing.Size(118, 14);
			// 
			// txButtonModelName
			// 
			this.txButtonModelName.Location = new System.Drawing.Point(600, 35);
			this.txButtonModelName.Name = "txButtonModelName";
			this.txButtonModelName.Size = new System.Drawing.Size(283, 20);
			this.txButtonModelName.StyleController = this.lc;
			this.txButtonModelName.TabIndex = 6;
			// 
			// emptySpaceItem1
			// 
			...
			this.lcItemInstance.Location = new System.Drawing.Point(0, 72);
			this.lcItemInstance.Name = "lcItemInstance";
			this.lcItemInstance.Size = new System.Drawing.Size(409, 24);
			this.lcItemInstance.TextSize = new System.Drawing.Size(118, 14);
			// 
			// txtInstance
			// 
			this.txtInstance.Location = new System.Drawing.Point(600, 83);
			this.txtInstance.Name = "txtInstance";
			this.txtInstance.Size = new System.Drawing.Size(283, 20);
			this.txtInstance.StyleController = this.lc;
			this.txtInstance.TabIndex = 20;
			// 
			// emptySpaceItem2
			// 
			this.emptySpaceItem2.AllowHotTrack = false;
			this.emptySpaceItem2.Location = new System.Drawing.Point(409, 72);
			...
			// txtCreatedOn
			// 
			this.txtCreatedOn.Location = new System.Drawing.Point(600, 244);
			...
			// txtCreatedByName
			// 
			this.txtCreatedByName.Location = new System.Drawing.Point(600, 268);
			...
			// txtUpdatedOn
			// 
			this.txtUpdatedOn.Location = new System.Drawing.Point(852, 244);
			...
			// txtUpdatedByName
			// 
			this.txtUpdatedByName.Location = new System.Drawing.Point(852, 268);
			...
			this.emptySpaceItem9.Size = new System.Drawing.Size(505, 186);
			...
			this.lcGroupEdit2.Size = new System.Drawing.Size(519, 200);
			...
			// lupButtonType
			// 
			this.lupButtonType.DisplayMember = "";
			this.lupButtonType.GroupCode = null;
			this.lupButtonType.ListMember = "ListName";
			this.lupButtonType.Location = new System.Drawing.Point(600, 59);
			this.lupButtonType.Name = "lupButtonType";
			this.lupButtonType.NullText = "[EditValue is null]";
			this.lupButtonType.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo),
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Redo)});
			this.lupButtonType.SelectedIndex = -1;
			this.lupButtonType.Size = new System.Drawing.Size(126, 20);
			this.lupButtonType.StyleController = this.lc;
			this.lupButtonType.TabIndex = 21;
			this.lupButtonType.ValueMember = "";
			// 
			// lcItemButtonType
			// 
			this.lcItemButtonType.Control = this.lupButtonType;
			this.lcItemButtonType.Location = new System.Drawing.Point(0, 48);
			this.lcItemButtonType.Name = "lcItemButtonType";
			this.lcItemButtonType.Size = new System.Drawing.Size(252, 24);
			this.lcItemButtonType.TextSize = new System.Drawing.Size(118, 14);
			// 
			// emptySpaceItem4
			// 
			this.emptySpaceItem4.AllowHotTrack = false;
			this.emptySpaceItem4.Location = new System.Drawing.Point(252, 48);
			...
			((System.ComponentModel.ISupportInitialize)(this.lcItemButtonName)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.txButtonModelName.Properties)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.lupButtonType.Properties)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.lcItemButtonType)).EndInit();
		...
		private DevExpress.XtraEditors.TextEdit txButtonModelName;
		private DevExpress.XtraEditors.TextEdit txtID;
		private DevExpress.XtraLayout.LayoutControlItem lcItemID;
		private DevExpress.XtraLayout.LayoutControlItem lcItemButtonName;
		...
		private Core.Controls.Common.XLookup lupButtonType;
		private DevExpress.XtraLayout.LayoutControlItem lcItemButtonType;
