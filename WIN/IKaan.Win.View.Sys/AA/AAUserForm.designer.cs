namespace IKaan.Win.View.Sys.AA
{
	partial class AAUserForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.lupUserType = new IKaan.Win.Core.Controls.Common.XLookup();
			...
			this.btnPasswordInit = new DevExpress.XtraEditors.SimpleButton();
			...
			this.gridUserGroup = new IKaan.Win.Core.Controls.Grid.XGrid();
			this.lcGroupEdit3 = new DevExpress.XtraLayout.LayoutControlGroup();
			this.layoutControlItem2 = new DevExpress.XtraLayout.LayoutControlItem();
			this.gridUserRole = new IKaan.Win.Core.Controls.Grid.XGrid();
			this.lcGroupEdit4 = new DevExpress.XtraLayout.LayoutControlGroup();
			this.layoutControlItem4 = new DevExpress.XtraLayout.LayoutControlItem();
			this.gridPasswordHistory = new IKaan.Win.Core.Controls.Grid.XGrid();
			...
			// lc
			// 
			this.lc.Controls.Add(this.btnPasswordInit);
			this.lc.Controls.Add(this.gridPasswordHistory);
			this.lc.Controls.Add(this.gridUserRole);
			this.lc.Controls.Add(this.gridUserGroup);
			...
			this.layoutControlItem3.Size = new System.Drawing.Size(448, 467);
			...
			this.gridList.Size = new System.Drawing.Size(444, 463);
			...
			this.lcGroupEdit1.Size = new System.Drawing.Size(520, 235);
			...
			this.lcItemUserName.Size = new System.Drawing.Size(506, 24);
			this.lcItemUserName.TextSize = new System.Drawing.Size(118, 14);
			// 
			// txtUserName
			// 
			this.txtUserName.Location = new System.Drawing.Point(607, 35);
			...
			this.lcItemDescription.Location = new System.Drawing.Point(0, 121);
			...
			// memDescription
			// 
			this.memDescription.Location = new System.Drawing.Point(607, 132);
			...
			this.lcItemLoginID.Size = new System.Drawing.Size(349, 26);
			this.lcItemLoginID.TextSize = new System.Drawing.Size(118, 14);
			// 
			// txtLoginID
			// 
			this.txtLoginID.Location = new System.Drawing.Point(607, 83);
			this.txtLoginID.Name = "txtLoginID";
			this.txtLoginID.Size = new System.Drawing.Size(223, 20);
			...
			this.lcItemUserType.Size = new System.Drawing.Size(267, 24);
			this.lcItemUserType.TextSize = new System.Drawing.Size(118, 14);
			// 
			// lupUserType
			// 
			...
			this.lupUserType.Location = new System.Drawing.Point(607, 59);
			...
			this.lupUserType.Size = new System.Drawing.Size(141, 20);
			this.lupUserType.StyleController = this.lc;
			this.lupUserType.TabIndex = 21;
			...
			this.lcItemUseYn.Location = new System.Drawing.Point(0, 98);
			...
			this.chkUseYn.Location = new System.Drawing.Point(607, 109);
			...
			this.emptySpaceItem3.Size = new System.Drawing.Size(70, 26);
			this.emptySpaceItem3.TextSize = new System.Drawing.Size(0, 0);
			// 
			// layoutControlItem5
			// 
			this.layoutControlItem5.Control = this.btnPasswordInit;
			this.layoutControlItem5.Location = new System.Drawing.Point(419, 72);
			...
			// btnPasswordInit
			// 
			this.btnPasswordInit.Location = new System.Drawing.Point(904, 83);
			this.btnPasswordInit.Name = "btnPasswordInit";
			this.btnPasswordInit.Size = new System.Drawing.Size(83, 22);
			this.btnPasswordInit.StyleController = this.lc;
			this.btnPasswordInit.TabIndex = 29;
			this.btnPasswordInit.Text = "비밀번호초기화";
			// 
			// splitterItem1
			// 
			...
			this.lcGroupRegInfo.Location = new System.Drawing.Point(0, 235);
			...
			// txtCreateDate
			// 
			this.txtCreateDate.Location = new System.Drawing.Point(607, 246);
			...
			// txtCreateByName
			// 
			this.txtCreateByName.Location = new System.Drawing.Point(607, 270);
			...
			// txtUpdateDate
			// 
			this.txtUpdateDate.Location = new System.Drawing.Point(860, 246);
			...
			// txtUpdateByName
			// 
			this.txtUpdateByName.Location = new System.Drawing.Point(860, 270);
			...
			// lcTabButtons
			// 
			this.lcTabButtons.Location = new System.Drawing.Point(0, 297);
			...
			this.lcTabButtons.Size = new System.Drawing.Size(520, 241);
			...
			this.lcGroupEdit2.Size = new System.Drawing.Size(510, 207);
			this.lcGroupEdit2.Text = "사용자그룹";
			// 
			// layoutControlItem1
			// 
			...
			// gridUserGroup
			// 
			this.gridUserGroup.Compress = false;
			this.gridUserGroup.DataSource = null;
			this.gridUserGroup.Editable = true;
			this.gridUserGroup.FocusedRowHandle = -2147483648;
			this.gridUserGroup.GridViewType = IKaan.Win.Core.Controls.Grid.GridViewType.GridView;
			this.gridUserGroup.Location = new System.Drawing.Point(483, 330);
			this.gridUserGroup.Name = "gridUserGroup";
			this.gridUserGroup.PageFooterCenter = null;
			this.gridUserGroup.PageFooterLeft = null;
			this.gridUserGroup.PageFooterRight = null;
			this.gridUserGroup.PageHeaderCenter = null;
			this.gridUserGroup.PageHeaderLeft = null;
			this.gridUserGroup.PageHeaderRight = null;
			this.gridUserGroup.Pager = null;
			this.gridUserGroup.PrintFooter = null;
			this.gridUserGroup.PrintHeader = null;
			this.gridUserGroup.ReadOnly = false;
			this.gridUserGroup.ShowFooter = false;
			this.gridUserGroup.ShowGroupPanel = false;
			this.gridUserGroup.Size = new System.Drawing.Size(506, 203);
			this.gridUserGroup.TabIndex = 26;
			// 
			// lcGroupEdit3
			// 
			...
			this.lcGroupEdit3.Size = new System.Drawing.Size(510, 207);
			this.lcGroupEdit3.Text = "권한그룹";
			// 
			// layoutControlItem2
			// 
			this.layoutControlItem2.Control = this.gridUserRole;
			this.layoutControlItem2.Location = new System.Drawing.Point(0, 0);
			this.layoutControlItem2.Name = "layoutControlItem2";
			this.layoutControlItem2.Size = new System.Drawing.Size(510, 207);
			this.layoutControlItem2.TextSize = new System.Drawing.Size(0, 0);
			this.layoutControlItem2.TextVisible = false;
			// 
			// gridUserRole
			// 
			this.gridUserRole.Compress = false;
			this.gridUserRole.DataSource = null;
			this.gridUserRole.Editable = true;
			this.gridUserRole.FocusedRowHandle = -2147483648;
			this.gridUserRole.GridViewType = IKaan.Win.Core.Controls.Grid.GridViewType.GridView;
			this.gridUserRole.Location = new System.Drawing.Point(483, 330);
			this.gridUserRole.Name = "gridUserRole";
			this.gridUserRole.PageFooterCenter = null;
			this.gridUserRole.PageFooterLeft = null;
			this.gridUserRole.PageFooterRight = null;
			this.gridUserRole.PageHeaderCenter = null;
			this.gridUserRole.PageHeaderLeft = null;
			this.gridUserRole.PageHeaderRight = null;
			this.gridUserRole.Pager = null;
			this.gridUserRole.PrintFooter = null;
			this.gridUserRole.PrintHeader = null;
			this.gridUserRole.ReadOnly = false;
			this.gridUserRole.ShowFooter = false;
			this.gridUserRole.ShowGroupPanel = false;
			this.gridUserRole.Size = new System.Drawing.Size(506, 203);
			this.gridUserRole.TabIndex = 27;
			// 
			// lcGroupEdit4
			// 
			...
			this.lcGroupEdit4.Size = new System.Drawing.Size(510, 207);
			this.lcGroupEdit4.Text = "비밀번호변경이력";
			// 
			// layoutControlItem4
			// 
			this.layoutControlItem4.Control = this.gridPasswordHistory;
			this.layoutControlItem4.Location = new System.Drawing.Point(0, 0);
			this.layoutControlItem4.Name = "layoutControlItem4";
			this.layoutControlItem4.Size = new System.Drawing.Size(510, 207);
			this.layoutControlItem4.TextSize = new System.Drawing.Size(0, 0);
			this.layoutControlItem4.TextVisible = false;
			// 
			// gridPasswordHistory
			// 
			this.gridPasswordHistory.Compress = false;
			this.gridPasswordHistory.DataSource = null;
			this.gridPasswordHistory.Editable = true;
			this.gridPasswordHistory.FocusedRowHandle = -2147483648;
			this.gridPasswordHistory.GridViewType = IKaan.Win.Core.Controls.Grid.GridViewType.GridView;
			this.gridPasswordHistory.Location = new System.Drawing.Point(483, 330);
			this.gridPasswordHistory.Name = "gridPasswordHistory";
			this.gridPasswordHistory.PageFooterCenter = null;
			this.gridPasswordHistory.PageFooterLeft = null;
			this.gridPasswordHistory.PageFooterRight = null;
			this.gridPasswordHistory.PageHeaderCenter = null;
			this.gridPasswordHistory.PageHeaderLeft = null;
			this.gridPasswordHistory.PageHeaderRight = null;
			this.gridPasswordHistory.Pager = null;
			this.gridPasswordHistory.PrintFooter = null;
			this.gridPasswordHistory.PrintHeader = null;
			this.gridPasswordHistory.ReadOnly = false;
			this.gridPasswordHistory.ShowFooter = false;
			this.gridPasswordHistory.ShowGroupPanel = false;
			this.gridPasswordHistory.Size = new System.Drawing.Size(506, 203);
			this.gridPasswordHistory.TabIndex = 28;
			// 
			// AAUserForm
			// 
			...
			this.Name = "AAUserForm";
			this.Text = "AAUserForm";
		...
		private IKaan.Win.Core.Controls.Common.XLookup lupUserType;
		...
		private Core.Controls.Grid.XGrid gridUserGroup;
		...
		private Core.Controls.Grid.XGrid gridPasswordHistory;
		private Core.Controls.Grid.XGrid gridUserRole;
		private DevExpress.XtraLayout.LayoutControlItem layoutControlItem4;
		private DevExpress.XtraLayout.LayoutControlItem layoutControlItem2;
		private DevExpress.XtraLayout.EmptySpaceItem emptySpaceItem3;
		private DevExpress.XtraEditors.SimpleButton btnPasswordInit;
