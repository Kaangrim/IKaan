...
{
	public partial class BMChannelManagerForm : EditForm
	{
		public BMChannelManagerForm()
		{
			InitializeComponent();
		}
		...
		protected override void DataLoad(object param = null)
		{
			...
			try
			{
				...
				var model = WasHandler.GetData<BMChannelManager>("BM", "GetData", "Select", parameter);
				if (model == null)
		...
		{
			ClearControlData<BMChannelManager>();
		...
		protected override void DataSave(object arg, SaveCallback callback)
		{
			try
			{
				var model = this.GetControlData<BMChannelManager>();

				using (var res = WasHandler.Execute<BMChannelManager>("BM", "Save", (this.EditMode == EditModeEnum.New) ? "Insert" : "Update", model, "ID"))
				{
		...
		protected override void DataDelete(object arg, DeleteCallback callback)
		{
			try
			{
				...
				using (var res = WasHandler.Execute<DataMap>("BM", "Delete", "DeleteBMChannelManager", map, "ID"))
				{
					if (res.Error.Number != 0)
						throw new Exception(res.Error.Message);
